...
class winner_controller extends Controller 
{
    ...
    //  public function add_winner(Request $request)------>working with mobile
    // {
    //     // Validate request data
    //     $validator = Validator::make($request->all(), [
    //         'timer_id' => 'required',
     ...
     public function get_winner(Request $request, $franchise_id, $timer_id)
    {
        ...
        if ($winner->isEmpty()) { // Check if collection is empty
            ...
            $success['message'] = "Winner Data retrieved successfully";
            $success['success'] = true;
    ...
    public function get_total_winner(Request $request, $franchise_id, $timer_id)
    {
        // Get current date
      //  $current_date = now()->toDateString();
